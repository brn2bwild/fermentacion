...
uint8_t sensor1[8] = { 0x28, 0xFF, 0x26, 0x6D, 0x01, 0x17, 0x03, 0xEA  };
uint8_t sensor2[8] = { 0x28, 0xFF, 0xBE, 0xE0, 0x01, 0x17, 0x03, 0x27  };
uint8_t sensor3[8] = { 0x28, 0xFF, 0x09, 0xA7, 0x01, 0x17, 0x04, 0xDC  };
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    uint16_t packetIdPub1 = mqttClient.publish(MQTT_PUB_TEMP1, 1, true, String(tempSensor1).c_str());                            
    ...
    uint16_t packetIdPub2 = mqttClient.publish(MQTT_PUB_TEMP2, 1, true, String(tempSensor2).c_str());                            
    ...
    uint16_t packetIdPub3 = mqttClient.publish(MQTT_PUB_TEMP3, 1, true, String(tempSensor3).c_str());                            
    Serial.printf("Publishing on topic %s at QoS 1, packetId: %i ", MQTT_PUB_TEMP3, packetIdPub3);
    Serial.printf("Message: %.2f \n", tempSensor3);
  }
}
